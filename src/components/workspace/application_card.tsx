...
const ApplicationCard = ({ application, setClickedOnApplication, setClickedApplication }: Props) => {
  return (
    <div
      ...
      className={`w-full font-primary dark:text-white border-[1px] dark:border-dark_primary_btn rounded-lg p-8 max-md:p-4 flex justify-between transition-ease-300 cursor-pointer`}
    >
