          ...
          <div className="flex flex-wrap gap-4 relative">
            {memberships.map((membership, index) => {
              return (
                ...
                >
                  {showIndex == index ? (
                    <div className="w-4/5 z-20 flex items-start justify-center gap-4 py-2 px-4 absolute top-12 right-1/2 translate-x-1/2 bg-white border-primary_btn border-[1px] dark:border-0 dark:bg-dark_primary_comp rounded-md animate-fade_third">
                      <Image
