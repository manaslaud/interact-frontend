...
const UserCard = ({ user }: Props) => {
  ...
  return (
    <div className="w-full font-primary dark:text-white border-[1px] dark:border-dark_primary_btn rounded-lg flex flex-col gap-4 px-5 py-4 transition-ease-300">
