...
const Welcome = ({ notification }: Props) => {
  return (
    <div className="relative">
      ...
      <div className="w-full bg-[#f6f6f6] flex flex-col px-4 py-4 rounded-xl items-center justify-between font-Helvetica transition-all duration-200 ease-in-out hover:bg-[#ebebeb]">
