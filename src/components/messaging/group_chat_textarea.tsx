...
const ChatTextarea = ({ chat }: Props) => {
  ...
  return (
    <textarea
      ...
      placeholder="Message..."
      className="w-full h-[64px] min-h-[64px] max-h-[132px] backdrop-blur-md bg-[#c578bf10] rounded-xl p-4 dark:text-white border-[1px] dark:border-dark_primary_btn overflow-auto focus:outline-none"
    />
  );
};
