...
const ConfirmDelete = ({ handleDelete, setShow, title = 'Confirm Delete?' }: Props) => {
  ...
  return (
    <>
      <div className="fixed top-48 max-md:top-20 w-1/3 max-md:w-5/6 h-1/3 max-md:h-fit backdrop-blur-2xl bg-white dark:bg-[#ffe1fc22] flex flex-col gap-2 max-md:gap-0 rounded-lg p-8 dark:text-white font-primary overflow-y-auto border-[1px] border-primary_btn  dark:border-dark_primary_btn right-1/2 shadow-md translate-x-1/2 animate-fade_third z-50">
