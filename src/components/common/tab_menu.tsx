...
const TabMenu = ({ items, active, setReduxState }: Props) => {
  ...
  return (
    <div className="w-[500px] h-[45px] p-1 rounded-lg bg-gradient-to-b from-primary_gradient_start to-primary_gradient_end shadow-outer mx-auto bg-slate-100 flex justify-around gap-1 sticky top-[88px] z-10">
      {/* 64+24=88 */}
