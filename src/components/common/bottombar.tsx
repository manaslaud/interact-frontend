...
const BottomBar = ({ index }: Props) => {
  ...
  return (
    <div className="w-full h-bottomBar flex justify-evenly items-center bg-white dark:bg-transparent backdrop-blur-xl backdrop-brightness-150 fixed bottom-0 right-0 lg:hidden border-gray-300 border-t-[1px] z-[60]">
