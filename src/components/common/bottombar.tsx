...
const BottomBar = ({ index }: Props) => {
  ...
  return (
    <div className="w-full h-bottomBar flex justify-evenly items-center backdrop-blur-xl backdrop-brightness-150 fixed bottom-0 right-0 md:hidden border-t-[1px] z-30">
