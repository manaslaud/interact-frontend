    ...
    >
      ...
      <div className="w-[calc(100vw-128px)] max-lg:w-screen h-screen pt-3">
        ...
        <div className="w-full h-[calc(100vh-56px)] max-lg:overflow-y-auto flex max-lg:flex-col">
          <div className="animate-pulse delay-20 bg-gray-200 dark:bg-dark_primary_comp w-3/4 max-lg:w-full h-full max-lg:h-96 rounded-tl-md max-lg:rounded-none"></div>

          <div className="w-1/4 max-lg:w-full border-gray-400 border-t-[1px] border-r-[1px] dark:border-0 h-full max-lg:h-fit max-lg:min-h-[calc(100vh-65px-384px)] overflow-y-auto p-4 bg-white dark:bg-dark_primary_comp_hover flex flex-col gap-4">
