...
const ProfileDropdown = ({ setShow }: Props) => {
  ...
  return (
    <>
      <div className="w-64 max-md:border-b-[1px] max-md:border-primary_btn bg-gray-200 bg-opacity-50 dark:bg-transparent dark:border-dark_primary_btn dark:text-white font-primary max-md:w-full max-h-[480px] max-md:max-h-none overflow-y-auto fixed top-[72px] max-md:top-navbar right-4 max-md:right-0 rounded-xl max-md:rounded-none backdrop-blur-lg backdrop p-2 z-50 animate-fade_third">
        <Link
          href={'/profile'}
