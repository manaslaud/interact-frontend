  ...
  return (
    ...
    >
      <ArrowDownLeft
        ...
        className={`absolute ${open ? 'top-0 right-0' : 'top-2 right-2 rotate-180'} transition-ease-500 cursor-pointer`}
        size={32}
      />
      {loading ? (
        <Loader />
        ...
        <>
          ...
          <div
            className={`w-full ${open ? 'text-base gap-6' : 'text-xxs gap-0'} transition-ease-500 flex justify-center`}
          >
