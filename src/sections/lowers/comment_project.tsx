...
const CommentProject = ({ project, setShow, setNoComments }: Props) => {
  ...
  return (
    <>
      <div className="w-[80%] h-[90%] max-md:w-5/6 max-md:overflow-y-auto fixed backdrop-blur-xl text-white dark:bg-[#1201103c] max-md:bg-[#2a192eea] z-30 translate-x-1/2 -translate-y-1/4 top-56 right-1/2 flex items-center max-md:flex-col font-primary p-8 max-md:p-4 gap-2 border-2 border-primary_btn  dark:border-dark_primary_btn rounded-xl">
