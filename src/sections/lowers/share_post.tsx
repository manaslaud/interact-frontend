...
const SharePost = ({ post, setShow }: Props) => {
  ...
  return (
    <>
      <div className="w-1/4 max-md:h-5/6 overflow-y-auto max-lg:w-5/6 fixed backdrop-blur-lg bg-[#ffffff] dark:bg-[#ffe1fc22] z-30 translate-x-1/2 -translate-y-1/4 top-64 right-1/2 flex flex-col px-8 py-8 gap-2 border-2 border-primary_btn  dark:border-dark_primary_btn rounded-xl">
