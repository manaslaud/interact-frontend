...
const EditCollaborator = ({ setShow, membership, project, setProject }: Props) => {
  ...
  return (
    <>
      <div className="fixed top-56 w-[560px] max-md:w-5/6 h-fit backdrop-blur-2xl bg-[#ffe1fc22] flex flex-col gap-4 rounded-lg p-10 dark:text-white font-primary overflow-y-auto border-[1px] border-primary_btn  dark:border-dark_primary_btn right-1/2 translate-x-1/2 animate-fade_third z-30">
        ...
        <div className="w-full flex justify-end">
          <div
            ...
            className="w-[90px] h-[40px] dark:bg-dark_primary_comp hover:bg-primary_comp_hover active:bg-primary_comp_active dark:hover:bg-dark_primary_comp_hover dark:active:bg-dark_primary_comp_active transition-ease-300 shrink-0 flex-center font-semibold rounded-lg cursor-pointer"
          >
            Edit
          </div>
        </div>
