...
const EditOpening = ({ setShow, opening, project, setProject }: Props) => {
  ...
  return (
    <>
      <div className="fixed top-24 max-md:top-20 w-[953px] max-md:w-5/6 h-[540px] max-md:h-2/3 backdrop-blur-2xl bg-[#ffe1fc22] flex flex-col justify-between rounded-lg p-10 dark:text-white font-primary overflow-y-auto border-[1px] dark:border-dark_primary_btn right-1/2 translate-x-1/2 animate-fade_third z-30">
