  ...
  return (
    <>
      ...
      <div className="w-screen h-screen">
        {!clickedOnBuild ? (
          <div className="glassMorphism animate-fade_1 page w-108 max-md:w-[90%] h-64 max-md:h-72 px-8 py-10 font-primary flex flex-col justify-between rounded-lg shadow-xl hover:shadow-2xl transition-ease-300 absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2">
            <div className="flex flex-col gap-2">
              <div className="text-5xl font-bold"> Build Your Profile</div>
