    ...
    <BaseWrapper>
      ...
      <MainWrapper>
        <div className="w-3/4 max-md:w-full mx-auto dark:text-white flex flex-col gap-2 px-8 max-md:px-4 py-6 font-primary relative transition-ease-out-500">
          ...
          <label className="w-full h-16 select-none text-xl flex-center gap-4 dark:bg-dark_primary_comp dark:hover:bg-dark_primary_comp_hover dark:active:bg-dark_primary_comp_active px-6 rounded-md text-center cursor-pointer transition-ease-300">
          ...
          <div
            ...
            className="w-full h-16 text-xl flex-center gap-4 dark:bg-dark_primary_comp dark:hover:bg-dark_primary_comp_hover dark:active:bg-dark_primary_comp_active px-6 rounded-md text-center cursor-pointer transition-ease-300"
          >
