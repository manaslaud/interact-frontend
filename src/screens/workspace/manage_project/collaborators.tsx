    ...
    <div className="w-[50vw] max-md:w-screen mx-auto flex flex-col gap-8">
      ...
      <div className="w-taskbar max-md:w-[95%] h-taskbar mx-auto flex gap-2 font-primary text-gray-200 text-lg">
        <div
          ...
          className="w-4/5 max-md:w-2/3 h-full text-gray-400 dark:text-gray-200 bg-white dark:bg-gradient-to-l dark:from-dark_primary_gradient_start dark:to-dark_primary_gradient_end px-4 max-md:px-2 py-3 rounded-lg cursor-pointer border-gray-300 border-[1px] dark:border-0 shadow-md dark:shadow-outer flex justify-between items-center"
        >
        ...
        <div
          ...
          }  dark:bg-gradient-to-l dark:from-dark_primary_gradient_start dark:to-dark_primary_gradient_end px-4 max-md:px-2 py-3 rounded-lg cursor-pointer border-gray-300 border-[1px] dark:border-0 shadow-md dark:shadow-outer flex justify-between items-center transition-ease-300`}
        >
          <div
