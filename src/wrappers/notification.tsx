...
const NotificationWrapper: React.FC<WrapperProps> = ({ children, notification }) => {
  return (
    <div className="w-full relative">
      ...
      <div className="w-full flex items-center justify-between gap-4 p-3 dark:text-white hover:bg-primary_comp_hover dark:hover:bg-[#ae8abd39] rounded-xl font-primary transition-ease-200">
